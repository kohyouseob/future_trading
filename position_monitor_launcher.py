...
class MonitorLauncherApp:
    ...
    def _build_ui(self):
        ...
        tk.Label(row1, text="KTR 값", width=6, font=tkfont.Font(size=9)).pack(side=tk.LEFT, padx=(0, 4))
        self._ktr_manual_value = tk.StringVar(value="")
        tk.Entry(row1, textvariable=self._ktr_manual_value, width=10, font=tkfont.Font(size=9)).pack(side=tk.LEFT, padx=(0, 4))
